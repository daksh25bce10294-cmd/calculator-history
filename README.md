...
Ensure Python is Installed: This program requires Python 3. You can check your version by running:
...
Run the Calculator: Execute the main script from your terminal:
